...
web      3        172.16.0.2:80   eu        HEALTHY  0
    ...
    \begin{frame}{Remaining Items}
        ...
        \begin{itemize}
            ...
            \item Authn/authz (skipped this in this xds implementation)
        \end{itemize}
    ...
    \begin{frame}{Other options}
        \begin{itemize}
        Of course you don't have to load balance?
        Once in xDS form you can change \emph{traffic} yourself to do what you want, just serve
